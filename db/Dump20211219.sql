...
CREATE TABLE `donphong` (
  ...
  `tinhtrang` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `dontour` (
  `id` int NOT NULL AUTO_INCREMENT,
  `iduser` int DEFAULT NULL,
  `hoten` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  ...
  `phuongthuc` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `tinhtrang` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `khachsan` (
  ...
  `tenKS` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tour` VALUES (1,'Vũng Tàu - Hồ Chí Minh','Vũng Tàu','Vũng Tàu - Hồ Chí Minh','2021-01-01','2021-02-02',300000,50,'https://luhanhvietnam.com.vn/tour-du-lich/vnt_upload/tour/03_2021/thumbs/380_crop_bai_nhat3.jpg','Máy Bay'),(2,'Hà Nội -  Đà Nẵng',' Đà Nẵng','Hà Nội -  Đà Nẵng','2021-01-01','2021-02-02',300000,50,'https://luhanhvietnam.com.vn/tour-du-lich/vnt_upload/tour/02_2020/thumbs/380_crop_du-lich-da-nang-tour.jpg','Máy Bay'),(5,'Hồ Chí Minh - Đà Nẵng','Đà Nẵng','Hồ Chí Minh - Đà Nẵng','2021-01-01','2021-02-02',300000,50,'https://luhanhvietnam.com.vn/tour-du-lich/vnt_upload/tour/02_2020/thumbs/380_crop_cau-tinh-yen-2.jpg','Máy Bay'),(6,'SaPa - Hồ Chí Minh','SaPa ','SaPa - Hồ Chí Minh','2021-01-01','2021-02-02',300000,50,'https://luhanhvietnam.com.vn/tour-du-lich/vnt_upload/tour/04_2021/thumbs/380_crop_swing-sapa-2.jpg','Máy Bay'),(7,'Vũng Tàu -  Hà Nội','Vũng Tàu','Vũng Tàu -  Hà Nội','2021-01-01','2021-02-02',300000,50,'https://luhanhvietnam.com.vn/tour-du-lich/vnt_upload/File/Image/hoi_an_ve_dem.jpg','Máy Bay'),(8,'Cần Thơ - Hà Nội','Cần Thơ ','Cần Thơ - Hà Nội','2021-01-01','2021-02-02',300000,50,'https://luhanhvietnam.com.vn/tour-du-lich/vnt_upload/tour/09_2020/cho-noi-cai-rang-can-tho.jpg','Máy Bay'),(9,'Cần Thơ -  Hồ Chí Minh','Cần Thơ ','Cần Thơ -  Hồ Chí Minh','2021-01-01','2021-02-02',300000,50,'https://luhanhvietnam.com.vn/tour-du-lich/vnt_upload/tour/02_2020/thumbs/780_crop_can_tho.jpg','Máy Bay');
